...
export const metadata: Metadata = {
  title: "Pricing — Tpat Premium",
  description: "Unlock unlimited Tpat practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=tpat&cadence=annual`;
